...
(function ($, L/*, window, document, undefined*/) {
    ...
    var bsMarkerIcon = L.divIcon({
            iconSize        : [14, 14],    //Point    null    Size of the icon image in pixels.
            iconAnchor      : null,        //Point    null    The coordinates of the "tip" of the icon (relative to its top left corner). The icon will be aligned so that this point is at the marker's geographical location. Centered by default if size is specified, also can be set in CSS with negative margins.
            //popupAnchor   : [0,0],       //Point    [0, 0]    The coordinates of the point from which popups will "open", relative to the icon anchor.
            tooltipAnchor   : [0,0],       //Point    [0, 0]    The coordinates of the point from which tooltips will "open", relative to the icon anchor.
            className       : 'lbm-icon',  //String    ''    A custom class name to assign to both icon and shadow images. Empty by default.
    });
...
//            tooltipAnchor: [20,20],
        ...
        *****************************************************/
        _bsMarker_onDragStart: function(){ this._map.ignoreNextEvent('click'); },
        _bsMarker_onDragEnd  : function(){ setTimeout( $.proxy( this._map.includeNextEvent, this._map, 'click'), 100 ); },
